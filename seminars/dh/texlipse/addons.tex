...
\newenvironment{mycite}[1]{\begin{quote}\cite{#1}\begin{itshape} ``}
{''\end{itshape}\end{quote}}

\newcommand{\filler}[0]{Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
