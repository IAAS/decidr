...
\begin{document}
  ...
  \nocite{wk_ws}
   ...
   \begin{center}--- --- --- !!!Trenner: ab hier ist Baustelle!!! --- --- ---\end{center}
    ...
    %TODO: was sind zusätzliche Einschränkungen (Beispiele)
    ...
    Es gibt zusätzlich Standards, die die Fähigkeiten von Web Services erweitern. Diese Standards haben gewöhnlich einen Namen nach dem Schema \germanquote{WS-\texttt{x}} (z.B. WS-Security, WS-Transaction). %TODO elaborate
