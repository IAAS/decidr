...
%FIXME: add handlers
  ...
  \section{Einleitung}
    % TODO: redo
    In der heutigen Software-Welt wird zunehmend auf Service-Orientierte Architekturen gesetzt. Das bedeutet, dass Anwendungen aus einzelnen Diensten aufgebaut werden, die sehr loose gekoppelt sind und über eine Art Netzwerk miteinander kommunizieren können. Durch diese Eigenschaften lassen sich auf SOA basierende Anwendungen schnell und effizient an neue Marktbedingungen anpassen.

    SOAs können durch Web Services implementiert werden.
