...
\begin{document}
  ...
  \section{Java und Web Services}
    ...
    XML-Konstrukte (unmarshalling) und vice versa (marshalling) übernimmt die Laufzeitumgebung,
    sofern man dies nicht explizit selbst übernimmt.
  ...
  \subsection{JAX-WS 2.0 (JSR-224)}
    ...
    einfachen Web Service braucht -- aber keine Methoden um Java-Klassen auf XML-Schema zu mappen.
    Dafür ist JAXB vorgesehen. Außerdem kann man mit JAX-WS kaum Metadaten fürs Deployment in die
    Java-Klassen einbringen. Hier ist die Verwendung von WS-Metadata vorgesehen.
  ...
  \subsection{WS-Metadata 2.0 (JSR-181)}
    ...
    \subsubsection{@SOAPBinding}\ \\
      ...
      %TODO: more detail: doc lit wrapped
    ...
    \hline
      parameterStyle &
      Gibt an, ob die Parameter den gesamten Inhalt der Nachricht wiedergeben (\germanquote{BARE}),
      oder ob sie in ein Element eingepackt werden (\germanquote{WRAPPED}). &
      WRAPPED \\
    \hline
    \end{tabulary} \vfill
    \tymin=10pt
  ...
  JAXB\cite{jsr_222} definiert Methoden zum Binding von Java-Klassen auf generierte XML-Schemas.%TODO: content

  \label{summary}
  \titlerunning{Zusammenfassung}
  \section{Zusammenfassung}
    In \decidr{} sollten wir folgende Spezifikationen in den angegebenen Versionen verwenden:%TODO: content
    \begin{itemize}
      \item JAX-WS 2.0
      \item JAXB 2.0
      \item SOAP 1.2
