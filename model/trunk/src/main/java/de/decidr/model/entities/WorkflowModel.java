...
public class WorkflowModel implements java.io.Serializable {
	...
	private Set<User> userAdministratesWorkflowModel = new HashSet<User>(0);
	...
	public WorkflowModel(Tenant tenant, User modifiedByUser, String name,
			...
			Set<User> userAdministratesWorkflowModel,
	...
	public Set<User> getUserAdministratesWorkflowModel() {
