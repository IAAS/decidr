 ...
 * @author AT
 */
public class WorkItemContainer extends Observable implements Container, Container.Filterable, Container.Ordered {
    ...
    public WorkItemContainer(){
        ...
        try{
            workItemList = userFacade.getWorkItems(userId, filterList, paginator);
