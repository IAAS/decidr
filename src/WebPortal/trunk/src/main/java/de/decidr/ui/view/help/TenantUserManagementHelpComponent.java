 ...
 * and contains information related to tenant user management
 * 
...
public class TenantUserManagementHelpComponent extends VerticalLayout {
    ...
    public TenantUserManagementHelpComponent(){
        ...
        inviteUserLabel = new Label("1) Login into DecidR and navigate to 'Edit user list' in the navigation bar.<br/>"
        ...
        inviteUserButton = new Button("How to invite users to tenant?", new ToggleLabelAction(inviteUserLabel));
        inviteUserButton.setStyleName(Button.STYLE_LINK);

        this.addComponent(inviteUserButton);
        this.addComponent(inviteUserLabel);
        
        removeUserLabel = new Label("1) Login into DecidR and navigate to 'Edit users' in the navigation bar.<br/>"
        ...
        removeUserButton = new Button("How to remove users from tenant?", new ToggleLabelAction(removeUserLabel));
        removeUserButton.setStyleName(Button.STYLE_LINK);

        this.addComponent(removeUserButton);
        this.addComponent(removeUserLabel);

        transferAdminLabel = new Label("1) Login into DecidR and navigate to the user administration by clicking on 'User' in the navigation bar.<br/>"
        ...
        transferAdminButton = new Button("How to transfer admin role to another user?", new ToggleLabelAction(transferAdminLabel));
