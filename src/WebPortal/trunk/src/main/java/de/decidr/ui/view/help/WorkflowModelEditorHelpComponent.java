...
public class WorkflowModelEditorHelpComponent extends VerticalLayout {
    ...
    public WorkflowModelEditorHelpComponent() {
        ...
        openModelButton = new Button("How to open existing model for editing?",
        ...
        clearModelButton = new Button(
                "How to remove all activities, containers, connections and variables from the workflow model?",
        ...
        addActivityLabel = new Label(
                "1) You are a tenant admin.  You  have a workflow model and want to insert one of the available activities.<br/>"
        ...
        addActivityButton = new Button("How to insert a new activity?",
        ...
        addContainerButton = new Button("How to insert a new container?",
        ...
        connectionLabel = new Label(
                "1) You are a tenant admin and you opened an existing workflow for editing.<br/>"
        ...
        connectionButton = new Button(
                "How to connect activites and containers?",
