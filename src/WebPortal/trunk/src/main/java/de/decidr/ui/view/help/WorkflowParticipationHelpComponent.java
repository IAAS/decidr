 ...
 * and contains information related to workflow participation
 * 
...
public class WorkflowParticipationHelpComponent extends VerticalLayout {
    ...
    public WorkflowParticipationHelpComponent(){
        ...
        currentTenantWorkItemsLabel = new Label("1) Login into DecidR and navigate to the 'My Work items' in the navigation bar.<br/>"
                +"2) The page shows you a list of your work items for the current tenant.<br/><br/>",
                Label.CONTENT_XHTML);
        currentTenantWorkItemsLabel.setVisible(false);
        currentTenantWorkItemsButton = new Button("How to display work items for the current tenant?", new ToggleLabelAction(currentTenantWorkItemsLabel));
        ...
        allTenantWorkItemsLabel = new Label("1) Login into DecidR and navigate to the 'My Work items' in the navigation bar.<br/>"
        ...
        allTenantWorkItemsButton = new Button("How to display work items for all tenants?", new ToggleLabelAction(allTenantWorkItemsLabel));
        ...
        startWorkOnItemLabel = new Label("1) Login into DecidR and navigate to  'My Work items' in the navigation bar.<br/>"
        ...
        startWorkOnItemButton = new Button("How to start working on a work item?", new ToggleLabelAction(startWorkOnItemLabel));
        ...
        resumeWorkOnItemLabel = new Label("1) Login into DecidR and navigate 'My Work items' in the navigation bar.<br/>"
        ...
        resumeWorkOnItemButton = new Button("How to register as tenant admin?", new ToggleLabelAction(resumeWorkOnItemLabel));
