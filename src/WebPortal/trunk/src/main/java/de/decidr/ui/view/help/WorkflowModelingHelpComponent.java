...
public class WorkflowModelingHelpComponent extends VerticalLayout{
    ...
    public WorkflowModelingHelpComponent(){
        ...
        createNewWorkflowModelLabel = new Label("1) Login into DecidR and navigate to the workflow modeling section by clicking on the 'create/ edit workflow models' navigation link.<br/>"
        ...
        createNewWorkflowModelButton = new Button("How to create a new workflow model?", new ToggleLabelAction(createNewWorkflowModelLabel));
        ...
        deleteWorkflowModelLabel = new Label("1) Login into DecidR and navigate to the workflow modeling section by clicking on the 'create/edit workflow models' navigation link.<br/>"
        ...
        deleteWorkflowModelButton = new Button("How to delete workflow models?", new ToggleLabelAction(deleteWorkflowModelLabel));
        ...
        lockWorkflowModelLabel = new Label("1) Login into DecidR and navigate to the workflow modeling section by clicking on the 'create/edit workflow models' navigation link.<br/>"
        ...
        lockWorkflowModelButton = new Button("How to lock/unlock workflow models?", new ToggleLabelAction(lockWorkflowModelLabel));
        ...
        importWorkflowModelLabel = new Label("1) Login into DecidR as tenant admin and navigate to the workflow modeling section by clicking on the 'create/edit workflow models' navigation link.<br/>"
        ...
        importWorkflowModelButton = new Button("How to import workflow model file?", new ToggleLabelAction(importWorkflowModelLabel));
        ...
        exportWorkflowModelButton = new Button("How to export workflow model file?", new ToggleLabelAction(exportWorkflowModelLabel));
        ...
        publishWorkflowModelLabel = new Label("1) Login into DecidR as tenant admin and navigate to the workflow modeling section by clicking on the 'create/edit workflow models' navigation link.<br/>"
        ...
        publishWorkflowModelButton = new Button("How to publish workflow models?", new ToggleLabelAction(publishWorkflowModelLabel));
        ...
        unpublishWorkflowModelLabel = new Label("1) Login into DecidR as tenant admin and navigate to the workflow modeling section by clicking on the 'create/edit workflow models' navigation link.<br/>"
        ...
        unpublishWorkflowModelButton = new Button("How to unpublish workflow models?", new ToggleLabelAction(unpublishWorkflowModelLabel));
        ...
        appointWorkflowAdminLabel = new Label("1) Login into DecidR as tenant admin and navigate to the workflow modeling section by clicking on the 'Models' navigation link.<br/>"
        ...
        appointWorkflowAdminButton = new Button("How to appoint workflow admins?", new ToggleLabelAction(appointWorkflowAdminLabel));
