 ...
 * This object is given as parameter to the StartConfigurationWindow where
 * the object is parsed so that the values stored in the file can
 * be shown to the user as a form and a tree.
 *
 * @author AT
 */
public class ShowStartConfigurationWindowAction implements ClickListener {
    ...
    private WorkflowModelFacade workflowModelFacade = new WorkflowModelFacade(new UserRole(userId));
