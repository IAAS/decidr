...
import de.decidr.ui.view.SuperAdminNavigationMenu;
import de.decidr.ui.view.UserListComponent;
import de.decidr.ui.view.UserNavigationMenu;
...
public class ShowUserListAction implements ClickListener {
    ...
    public void buttonClick(ClickEvent event) {
        ...
        siteFrame.setVerticalNavigation(UserNavigationMenu.getInstance());
