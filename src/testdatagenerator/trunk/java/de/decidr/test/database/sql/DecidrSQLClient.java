...
public class DecidrSQLClient extends JFrame {
    ...
    JComboBox jcboURL = new JComboBox(
            new String[] { "jdbc:mysql://iaassrv7.informatik.uni-stuttgart.de:3306/decidrdb" });
    ...
    public DecidrSQLClient() {
        ...
        jbtConnectDB1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if(jtfUsername.getText().equals("") || jpfPassword.getPassword().equals("")){
