...
public class ConfigurationFactory {
    ...
    public static void main(String[] args) throws JAXBException {
        ...
        description.setType(new QName(XMLConstants.W3C_XML_SCHEMA_NS_URI,"string"));
        
        Property userNotification = factory.createProperty();
        userNotification.setName("userNotification");
        userNotification.setType(new QName(XMLConstants.W3C_XML_SCHEMA_NS_URI,"boolean"));
        
        Property taskDescription = factory.createProperty();
        taskDescription.setName("taskDescription");
        taskDescription.setType(new QName(XMLConstants.W3C_XML_SCHEMA_NS_URI,"string"));
        ...
        taskDescription_Alias.setPropertyName(new QName(taskDescription.getName()));
        ...
        PropertyAliases humanTaskPropertyAliases = factory.createPropertyAliases();
        ...
        to.setName("to");
        to.setType(new QName("http://decidr.de/schema/DecidrTypes","tAbstractUserList"));
        
        Property cc = factory.createProperty();
        cc.setName("cc");
        cc.setType(new QName("http://decidr.de/schema/DecidrTypes","tAbstractUserList"));
        
        Property bcc = factory.createProperty();
        bcc.setName("bcc");
        bcc.setType(new QName("http://decidr.de/schema/DecidrTypes","tAbstractUserList"));
        
        Property subject = factory.createProperty();
        subject.setName("subject");
        subject.setType(new QName(XMLConstants.W3C_XML_SCHEMA_NS_URI,"string"));
        
        Property message = factory.createProperty();
        message.setName("message");
        message.setType(new QName(XMLConstants.W3C_XML_SCHEMA_NS_URI,"string"));
        
        Property attachement = factory.createProperty();
        attachement.setName("attachement");
        attachement.setType(new QName("http://decidr.de/schema/DecidrTypes","tIDList"));
        ...
        JAXBContext webCon = JAXBContext.newInstance(WebserviceMapping.class);
        Marshaller marshaller = webCon.createMarshaller();
        marshaller.setProperty(Marshaller.JAXB_ENCODING, "UTF-8");
        marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
        marshaller.marshal(new JAXBElement<WebserviceMapping>(
                new QName("http://decidr.de/schema/wsmapping","mapping"), WebserviceMapping.class, humanTask ), System.out);
        marshaller.marshal(new JAXBElement<WebserviceMapping>(
                new QName("http://decidr.de/schema/wsmapping","mapping"), WebserviceMapping.class, email ), System.out);
