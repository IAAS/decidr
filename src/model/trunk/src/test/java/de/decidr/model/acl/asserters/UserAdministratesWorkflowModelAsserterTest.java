...
/**
 * Test case for <code>{@link UserAdministratesWorkflowModelAsserter}</code>.
 * NOTE: see <code>{@link DefaultAccessControlListTest}</code>
 * 
 * @author Geoffrey-Alexeij Heinze
 */
public class UserAdministratesWorkflowModelAsserterTest extends
    ...
    public void testAssertRule() throws TransactionException {
        ...
        assertTrue(asserter.assertRule(new WorkflowAdminRole(workflowAdminId),
                new CommandPermission(new StartWorkflowInstanceCommand(
                        new WorkflowAdminRole(workflowAdminId), wfmId, null,
                        true))));
