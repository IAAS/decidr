 ...
 * @author GH
 */
public class UserAdministratesWorkflowModelAsserterTest extends LowLevelDatabaseTest {
    ...
    public static void setUpBeforeClass() throws TransactionException {
        ...
        workflowAdminId = userFacade.registerUser(UserFacadeTest.getTestEmail(1), "qwertz", userProfile);
...
//        tenantFacade.deleteTenant(tenantId);
    ...
    /**
     * Test method for {@link UserAdministratesWorkflowModelAsserter#assertRule(Role, Permission)}.
     * @throws TransactionException 
     */
    @Test
    public void testAssertRule() throws TransactionException {
        UserAdministratesWorkflowModelAsserter asserter = new UserAdministratesWorkflowModelAsserter();
        assertTrue(asserter.assertRule(new WorkflowAdminRole(workflowAdminId),
                                       new CommandPermission(new StartWorkflowInstanceCommand(new WorkflowAdminRole(workflowAdminId)
                                                                                               , wfmId, null, true))));
