...
public class SetAdvancedColorSchemeCommand extends TenantCommand {
    ...
    /**
     * 
     * Creates a new SetAdvancedColorSchemeCommand. This command sets the advanced color scheme of the given tenant.
     * 
     * @param role      user which executes the command
     * @param tenantId  the id of the tenant where the advanced color scheme should be set
     * @param simpleColorScheme the color scheme file
     * @param mimeType  mime type of the file
     * @param fileName  name of the file
     */
    public SetAdvancedColorSchemeCommand(Role role, Long tenantId, FileInputStream advancedColorScheme, String mimeType,
            String fileName) {
    ...
    public void transactionAllowed(TransactionEvent evt)
        ...
        try {
            factory.getStorageProvider().putFile(advancedColorScheme, schemeFile.getId());
