...
public class NotificationText {
    ...
    /*
     *  
     * All functions require the parameter 
     * signature, which represents the last sentence
     * of the generated messages and should be sth.
     * like "--Your DecidR Team"
     *
     */
     ...
     * account has been (re-)activated by a super admin
     * 
     * @param userName
     * @param signature
    ...
    public static String getActivatedUserAccountText(String userName,
        ...
        message = "Dear " + userName +",<br><br>"+
                  "We like to inform you that your DecidR account “" + userName + "” has been activated.<br>"+
    ...
    /**
     * 
     * Returns the email text which is sent to a registered user,
     * who is already member of a tenant and has been appointed
     * to a workflowmodel admin of this tenant
     * 
     * @param userName
     * @param promoterName
     *          username of the tenant admin, who appointed this
     *          user to wfm admin
     * @param tenantName
     * @param wfmName
     ...
     * @return complete email message
     */
    public static String getAppointedWorkflowModelAdminText(
            String userName, String promoterName, String tenantName,
            String wfmName, String signature){
        String message = null;
        message = "Dear " + userName +"!<br><br>"+
                  promoterName + " from the tenant " + tenantName + " has promoted you to the role of Workflow Administrator for the following Workflow Model:<br>"+
                  wfmName + "<br><br><br>"+
                  signature + "<br>" +
                  "(Please do not respond to this automatically generated mail)";
     ...
     * 
     * Returns the email text which is sent to a user, whose 
     * attempt to create a new tenant has been approved.
     * 
     * @param userName
     * @param tenantName
     * @param signature
     * @return complete email message
     */
    public static String getAprovedTenantText(String userName,
            String tenantName, String signature) {
        String message = null;
        message = "Dear " + userName +",<br><br>"+
                  "We are happy to inform you that your request to create the tenant "+ tenantName +" has been approved."+
                  "You have been set as tenant admin automatically and are now able to customize your tenant and invite other users to join your tenant.<br><br><br>"+
                  signature + "<br>" +
                  "(Please do not respond to this automatically generated mail)";
    ...
    public static String getChangeEmailRequestText(String userName,
        ...
        message = "Dear " + userName + ",<br><br>" +
                  ...
                  "If clicking the link in this message does not work, copy and paste it into the address bar of your browser.<br><br>"+
                  "Please note that the provided link is only valid for 3 days an will expire on "+expireDate+".<br><br><br>"+
                  signature + "<br>" +
                  "(Please do not respond to this automatically generated mail)";
    ...
    /**
     * 
     * Returns the email text which is sent to a newly registered
     * user to confirm and activate his account.
     * 
     * @param userName
     * @param confirmationUrl
     * @param expireDate
    ...
    public static String getConfirmRegistrationText(String userName,
        ...
        message = "Dear "+ userName + ",<br><br>"+
                  ...
                  confirmationUrl+"<br><br>"+
                  "If clicking the link in this message does not work, copy and paste it into the address bar of your browser.<br><br>"+
                  "Please note that the provieded link is only valid for 3 days and will expire on "+expireDate+".<br><br><br>"+
                  signature + "<br>" +
                  "(Please do not respond to this automatically generated mail)";
     ...
     * 
     * Returns the email text which is sent to a user, whose
     * account has been deactivated by a super admin
     * 
     * @param userName
     * @param signature
     * @return complete email message
    ...
    public static String getDeactivatedUserAccountText(String userName,
        ...
        String message = null;
        message = "Dear " + userName +",<br><br>"+
                  "We regret to inform you that your DecidR account “" + userName + "” has been deactivated.<br>"+
    ...
    public static String getDisaprovedTenantText(String userName,
        ...
        String message = null;
        message = "Dear " + userName +",<br><br>"+
                  "Unfortunately your request to create the tenant "+ tenantName +" has been rejected.<br><br><br>"+
                  signature + "<br>" +
                  "(Please do not respond to this automatically generated mail)";
    ...
    public static String getGeneratedNewPasswordText(String userName,
        ...
        message = "Dear "+ userName +",<br><br>"+
                  ...
                  "Your new generated password is: "+ newPassword + "<br>"+
    ...
    public static String getInviteRegisteredUserAsTenantMemberText(
        ...
        String message = null;
        message = "Dear "+ userName +"!<br><br>"+
                  inviterName+" invited you to join the following DecidR tenant: "+tenantName+"<br>"+
                  "For further information about this tenant, please visit "+ tenantUrl +"<br><br>"+
                  "Please visit the following link and follow the instructions on the website to join the tenant:"+
                  invitationUrl+"<br><br>"+
                  "If clicking the link in this message does not work, copy and paste it into the address bar of your browser.<br><br>"+
                  "Please note that this invitation is only valid for 3 days and will expire on "+expireDate+".<br><br><br>"+
                  signature + "<br>" +
                  "(Please do not respond to this automatically generated mail)";
    ...
    public static String getInviteUnregisteredUserAsTenantMemberText(
        ...
        message = "Hello!<br><br>"+
                  inviterName+" invited you to join the following DecidR tenant: "+tenantName+"<br>"+
                  "For further information about this tenant, please visit "+ tenantUrl +"<br><br>"+
                  "Please visit the following link and follow the instructions on the website to create your own DecidR account and join the tenant:"+
                  invitationUrl+"<br><br>"+
                  "If clicking the link in this message does not work, copy and paste it into the address bar of your browser.<br><br>"+
                  "Please note that this invitation is only valid for 3 days and will expire on "+expireDate+".<br><br><br>"+
                  signature + "<br>" +
    ...
    public static String getNewWorkItemText(String userName, String tenantName,
        ...
        String message = null;
        message = "Dear "+userName+",<br><br>"+
                  "You have received a new work item from your tenant "+ tenantName + ".<br><br><br>"+
                  signature + "<br>" +
                  "(Please do not respond to this automatically generated mail)";
    ...
    public static String getPasswordResetRequestText(String userName,
        ...
        String message = null;
        message = "Dear " + userName + ",<br><br>"+
                  "You have requested a reset of your password. If that was not the case, please ignore this email.<br>"+
    ...
    public static String getRefusedInvitationText(String userName,
        ...
        String message = null;
        message = "Dear "+ userName +",<br><br>"+
                  "The user " + refusedByName + " has refused your invitation to join the tenant " + tenantName + ".<br><br><br>"+
                  signature + "<br>" +
                  "(Please do not respond to this automatically generated mail)";
    ...
    public static String getRemovedFromTenantText(String userName,
        ...
        String message = null;
        message = "Dear "+ userName + ",<br><br>"+
                  "You have been removed from the following tenant: " + tenantName + "<br>"+
