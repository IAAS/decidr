...
public class GetUsersOfTenantCommand extends TenantCommand {
    ...
    /**
     * 
     * Creates a new GetUsersOfTenantCommand. The Command saves
     * the Users of the given tenant in the result variable.
     * The tenant admin will not be part of the result.
     * 
    ...
    public void transactionAllowed(TransactionEvent evt)
        ...
        c.createCriteria("userIsMemberOfTenants").add(Restrictions.eq("tenant",t)).createCriteria("userProfile",Criteria.INNER_JOIN).setProjection(plist);
