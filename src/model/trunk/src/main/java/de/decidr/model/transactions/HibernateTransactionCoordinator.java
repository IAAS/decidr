...
public class HibernateTransactionCoordinator implements TransactionCoordinator {
    ...
    public void setConfiguration(Configuration config) {
        logger.log(Priority.DEBUG_INT, "Setting new Hibernate configuration.");
        if (config == null) {
