...
public interface ODEMonitorService {
    ...
    public void updateStats(
            @WebParam(name = "wfInstances", targetNamespace = "") BigInteger wfInstances,
            @WebParam(name = "wfModels", targetNamespace = "") BigInteger wfModels,
    ...
    public void getConfig(
            @WebParam(name = "updateInterval", targetNamespace = "", mode = WebParam.Mode.OUT) Holder<BigInteger> updateInterval,
