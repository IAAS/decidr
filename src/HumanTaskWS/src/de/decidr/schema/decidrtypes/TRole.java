...
public class TRole implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = tRole
	...
	protected de.decidr.schema.decidrtypes.TActor localActor;

	/**
	 * Auto generated getter method
	 * 
	 * @return de.decidr.schema.decidrtypes.TActor
	 */
	public de.decidr.schema.decidrtypes.TActor getActor() {
		return localActor;
	}
	 ...
	 *            Actor
	 */
	public void setActor(de.decidr.schema.decidrtypes.TActor param) {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				TRole.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":tRole", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"tRole", xmlWriter);
		...
		localActor.serialize(new javax.xml.namespace.QName(
				"http://decidr.de/schema/DecidrTypes", "actor"), factory,
				xmlWriter);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TRole parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			TRole object = new TRole();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"tRole".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (TRole) de.decidr.webservices.humantask.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setActor(de.decidr.schema.decidrtypes.TActor.Factory
							.parse(reader));
