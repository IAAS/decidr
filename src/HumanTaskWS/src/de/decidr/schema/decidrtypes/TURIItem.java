...
public class TURIItem extends de.decidr.schema.decidrtypes.TItem implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = tURIItem
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				TURIItem.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":tURIItem", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "tURIItem", xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		attribList.add(new javax.xml.namespace.QName(
				"http://decidr.de/schema/DecidrTypes", "tURIItem"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TURIItem parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			TURIItem object = new TURIItem();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"tURIItem".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (TURIItem) de.decidr.webservices.humantask.ExtensionMapper
