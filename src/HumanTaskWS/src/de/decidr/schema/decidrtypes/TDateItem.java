...
/**
 * TDateItem bean class
 */

public class TDateItem extends de.decidr.schema.decidrtypes.TItem implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * tDateItem Namespace URI = http://decidr.de/schema/DecidrTypes Namespace
	 * Prefix = ns1
	 */
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				TDateItem.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":tDateItem", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "tDateItem", xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		attribList.add(new javax.xml.namespace.QName(
				"http://decidr.de/schema/DecidrTypes", "tDateItem"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TDateItem parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			TDateItem object = new TDateItem();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"tDateItem".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (TDateItem) de.decidr.webservices.humantask.ExtensionMapper
