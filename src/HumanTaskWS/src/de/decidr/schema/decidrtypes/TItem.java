...
public class TItem implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = tItem
	...
	protected boolean localReadOnly = org.apache.axis2.databinding.utils.ConverterUtil
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				TItem.this.serialize(parentQName, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":tItem", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"tItem", xmlWriter);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TItem parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			TItem object = new TItem();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"tItem".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (TItem) de.decidr.webservices.humantask.ExtensionMapper
