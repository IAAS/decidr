...
/**
 * TStringItem bean class
 */

public class TStringItem extends de.decidr.schema.decidrtypes.TItem implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * tStringItem Namespace URI = http://decidr.de/schema/DecidrTypes Namespace
	 * Prefix = ns1
	 */
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				TStringItem.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":tStringItem", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "tStringItem", xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		attribList.add(new javax.xml.namespace.QName(
				"http://decidr.de/schema/DecidrTypes", "tStringItem"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TStringItem parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			TStringItem object = new TStringItem();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"tStringItem".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (TStringItem) de.decidr.webservices.humantask.ExtensionMapper
