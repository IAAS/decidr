...
/**
 * TIntegerItem bean class
 */

public class TIntegerItem extends de.decidr.schema.decidrtypes.TItem implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * tIntegerItem Namespace URI = http://decidr.de/schema/DecidrTypes
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				TIntegerItem.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":tIntegerItem", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "tIntegerItem", xmlWriter);
		}
		...
		if (true) {
			...
			writeAttribute("", "readOnly",
					org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localReadOnly), xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		attribList.add(new javax.xml.namespace.QName(
				"http://decidr.de/schema/DecidrTypes", "tIntegerItem"));

		elementList.add(new javax.xml.namespace.QName(
				"http://decidr.de/schema/DecidrTypes", "hint"));

		if (localHint != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localHint));
		} else {
			throw new org.apache.axis2.databinding.ADBException(
					"hint cannot be null!!");
		}
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://decidr.de/schema/DecidrTypes", "label"));
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://decidr.de/schema/DecidrTypes", "value"));
		...
		attribList.add(new javax.xml.namespace.QName("", "readOnly"));

		attribList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localReadOnly));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TIntegerItem parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			TIntegerItem object = new TIntegerItem();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"tIntegerItem".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (TIntegerItem) de.decidr.webservices.humantask.ExtensionMapper
				...
				java.lang.String tempAttribReadOnly =

				reader.getAttributeValue(null, "readOnly");

				if (tempAttribReadOnly != null) {
					java.lang.String content = tempAttribReadOnly;

					object
							.setReadOnly(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToBoolean(tempAttribReadOnly));
				...
				if (reader.isStartElement()
					...
					object
							.setHint(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
					...
					object
							.setLabel(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
