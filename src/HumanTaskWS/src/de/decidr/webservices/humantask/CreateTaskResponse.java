...
/**
 * CreateTaskResponse bean class
 */

public class CreateTaskResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://decidr.de/webservices/HumanTask", "createTaskResponse",
			"ns2");
	...
	protected de.decidr.schema.decidrtypes.TID localTaskID;
	 ...
	 */
	public de.decidr.schema.decidrtypes.TID getTaskID() {
		return localTaskID;
	}
	 ...
	 *            TaskID
	 */
	public void setTaskID(de.decidr.schema.decidrtypes.TID param) {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				CreateTaskResponse.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":createTaskResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"createTaskResponse", xmlWriter);
			}
		...
		localTaskID.serialize(new javax.xml.namespace.QName("", "taskID"),
				factory, xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName("", "taskID"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static CreateTaskResponse parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			CreateTaskResponse object = new CreateTaskResponse();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"createTaskResponse".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (CreateTaskResponse) de.decidr.webservices.humantask.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setTaskID(de.decidr.schema.decidrtypes.TID.Factory
							.parse(reader));
