...
/**
 * RemoveTasks bean class
 */

public class RemoveTasks implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://decidr.de/webservices/HumanTask", "removeTasks", "ns2");
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				RemoveTasks.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":removeTasks", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"removeTasks", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static RemoveTasks parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			RemoveTasks object = new RemoveTasks();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"removeTasks".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (RemoveTasks) de.decidr.webservices.humantask.ExtensionMapper
